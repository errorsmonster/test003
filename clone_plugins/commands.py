...
from utils import get_settings, get_size, is_req_subscribed, is_reqa_subscribed, save_group_settings, temp, verify_user, check_token, check_verification, get_token, get_shortlink, get_tutorial
...
async def start(client, message):
    ...
    if len(message.command) != 2:
        ...
        if curr_time < 12:
            ...
            gtxt = "Gᴏᴏᴅ ɴɪɢʜT 🥱😪👋"
        m=await message.reply_text("<i>ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ <b>ᴍʀ ᴍᴏᴠɪᴇꜱ ᴄʟᴏɴᴇ ʙᴏᴛ</b>.\nʜᴏᴘᴇ ʏᴏᴜ'ʀᴇ ᴅᴏɪɴɢ ᴡᴇʟʟ...</i>")
    ...
    if len(message.command) == 2 and message.command[1] in ["subscribe", "error", "okay", "help"]:
        buttons = [[
                    ...
                    InlineKeyboardButton(' UᴘᴅᴀΔᴛᴇꜱ •', callback_data='channels')
                ],[
    ...
    if data.startswith("sendfiles"):
        ...
        for file in files:
            ...
            [
             ...
             [
              InlineKeyboardButton('📌 ᴊᴏɪɴ ᴜᴘᴅᴀᴛᴇꜱ ᴄʜᴀɴɴᴇʟ 📌', url=f'https://t.me/HPD') #Don't change anything without contacting me @LazyDeveloperr
             ]
            ]
        )
    )
